...
def draw_box_on_image(num_hands_detect, score_thresh, scores, boxes, classes, im_width, im_height, image_np, safety_position):
	focal_length = 875
	avg_width = 4.0
	...
	for i in range(num_hands_detect):
		...
		if scores[i] > score_thresh:
			...
			cv2.putText(image_np, 'hand '+str(i)+': '+item, (int(x_min), int(y_min)-5),
			...
			alert_check(image_np, im_width, im_height, safety_position, p1, p2, point_dict)
...
def alert_check(image_np, im_width, im_height, safety_position, p1, p2, point_dict):
